...
import com.qa.data.SearchUserResource;
...
public class SearchUserTest extends TestBase {
    ...
    File file = new File("src/test/resources/json/searchUser.json");
    ...
    public void setUp() {
        ...
        serviceUrl = prop.getProperty("serviceURLSearchUser");
    ...
    @Test
        ...
        MyClass<SearchUserResource> myClass = new MyClass<SearchUserResource>(SearchUserResource.class);
